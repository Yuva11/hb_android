...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = Color.parseColor("#d21617");
	...
	private int tabTextColor = Color.parseColor("#8f2529");
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		defaultTabLayoutParams = new LinearLayout.LayoutParams(
				MainActivity.width / 2, LayoutParams.MATCH_PARENT);
	...
	public void setViewPager(ViewPager pager) {
		...
		Log.e("Setting View Pager", "setViewPager");
	...
	public void notifyDataSetChanged() {
		...
		Log.e("Notify data set", "Selected Text:" + tabCount);
	...
	private void updateTabStyles() {
		Log.e("TabCounts", "updateTabStyles:" + tabCount);
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				if (selectedText == i)
					...
					tab.setTextColor(Color.parseColor("#a6a6a6"));
				}
	...
	protected void onDraw(Canvas canvas) {
		...
		if (isInEditMode() || tabCount == 0) {
			Log.e("Tab On Draw", "tabCount:" + tabCount + ":isInEditMode:"
					+ isInEditMode());
			return;
		}
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			// Singleton.getInstance().setSelectedTab(position);
			updateTabStyles();
		}
